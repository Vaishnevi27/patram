<?php
	...
	if(isset($_POST['changePassword-submit'])){
		...
		$sql = "select * from login_admin where id = '$un' and password = '$cpaw' ";
		$result = mysqli_query($con,$sql);
		$count = mysqli_num_rows($result);
		if($count == 1){
			$sql = "update login_admin set password = '$npaw' where id = '$un' ";
			$result = mysqli_query($con,$sql);
...
<form action="adminH.php" method="post">
						...
						<div class="col-lg-12">
							...
							<form action="AdminchangePassword.php" method="post">
								<div class="form-group">
									<input type="text" name="mis" id="mis" tabindex="1" class="form-control" placeholder="username"  value="<?php echo $un; ?>">
								</div>
								<div class="form-group">
