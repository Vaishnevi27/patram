<?php
	...
	if(isset($_POST['update'])){
		...
		header('location:updateDraft.php');
	}
	...
	$sql = "select * from drafts as d,faculty as f where d.mis = f.mis and f.mis = '$mis' order by date_on_doc";
	$result = mysqli_query($con,$sql);	
	if($result){
		...
		while($row = mysqli_fetch_array($result)){
			$_SESSION['ids'][] = $row['id'];
			$table .= '<form action="showDrafts.php" method="post" enctype="multipart/form-data">';
				$table .= "<tr>";
				$table .= "<td>" . $row['id'] . "</td>";
	...
	<div class="container-fluid">
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="#">Drafts</a></li>
...
<div class="container-fluid">
	<div class="col-lg-12">
		<h1 align="center" class="well">My drafts</h1>
		<div class="row">
				<?php echo $table; ?>
		</div>
	</div>
