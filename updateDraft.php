<?php
	...
	if(isset($_POST['update'])){
		...
		$sql = "insert into uploads (mis, title, type, date_on_doc, date_of_upload, location, description) value ('$mis', '$title', '$type', '$date_on_doc', '$date_of_upload', '$filename','$description')";
...
<div class="container-fluid">    
	...
	<div class="col-lg-8 well">
	    <h1 align="center" class="well">Update Draft</h1>
		<div class="row">
				<form action="updateDraft.php" method="post" enctype="multipart/form-data">
				<div class="col-sm-12">
					<div class="row">
	...
	<div class="col-lg-2 well">
		<form action="showDrafts.php" method="post">
